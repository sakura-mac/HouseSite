                    ...
                    <div className="widget-item-2 widget-item-3 mt-30">
                      ...
                      <div style={{
                        ...
                        <div style={{textAlign: 'center', flex: '0 0 calc(50% - 10px)', marginBottom: '10px'}}>
                          <img src="contact/whatsapp.jpg" alt="WhatsApp" style={{maxWidth: '60%', height: 'auto'}}/>
                          <p style={{fontSize: '14px', color: 'white'}}>WhatsApp</p>
                        </div>
                        <div style={{textAlign: 'center', flex: '0 0 calc(50% - 10px)', marginBottom: '10px'}}>
                          <img src="contact/wechat.jpg" alt="微信" style={{maxWidth: '60%', height: 'auto'}}/>
                          <p style={{fontSize: '14px', color: 'white'}}>微信</p>
                        </div>
                        <div style={{textAlign: 'center', flex: '0 0 calc(50% - 10px)', marginBottom: '10px'}}>
                          <img src="contact/line.jpg" alt="LINE" style={{maxWidth: '60%', height: 'auto'}}/>
